    ...
    return (
        <div className="bg-white border border-gray-100 rounded-lg p-3 sm:p-4 h-full flex flex-col hover:shadow-md transition-shadow group/card relative">
            ...
            <div className="mt-auto">
                ...
                <button className="w-full py-2 sm:py-2.5 rounded-md border-2 border-[#02B290]/10 bg-white text-primary font-bold text-[12px] sm:text-[14px] hover:bg-primary hover:text-white transition-all duration-200 cursor-pointer">
                    Add to Cart
                </button>
            </div>
        </div>
